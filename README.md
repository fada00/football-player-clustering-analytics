...
The final output will be a web application (Streamlit/Dash) serving as a scouting tool:
* **Role Calculator:** Users can upload a player's stats (CSV) and the model will predict their specific tactical role.
* **Visual Profiling:** Radar charts comparing a player's stats against the "Ideal Prototype" of their assigned role.
* **Historical Evolution:** Tracking how player roles have shifted from 1992 to 2025.

## 📂 Dataset
* **Source:** Comprehensive dataset covering major leagues from **1992 to 2025**.
* **Features:** Detailed metrics including xG, Progressive Carries, Pressing Actions, and Passing Zones.
